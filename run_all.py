...
def main():
    ...
    print("="*60)
    print(f"\n🌐 Frontend:    \033]8;;{frontend_url}\033\\{frontend_url}\033]8;;\033\\")
    print(f"🔧 Backend API: \033]8;;{backend_url}\033\\{backend_url}\033]8;;\033\\")
    print(f"📚 API Docs:    \033]8;;{backend_url}/docs\033\\{backend_url}/docs\033]8;;\033\\")
    print(f"❤️  Health:      \033]8;;{backend_url}/api/health\033\\{backend_url}/api/health\033]8;;\033\\")
    print("\n" + "="*60)
